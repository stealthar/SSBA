...
LOCAL_MODULE	:= V3D
LOCAL_CFLAGS	:= -fPIC -D_ANDROID_BUILD -D_ANDROID_DEBUG_BUILD -DV3DLIB_ENABLE_SUITESPARSE -std=c++11 -fexceptions
LOCAL_CPPFLAGS 	+= 
LOCAL_SRC_FILES	:= \
...
LOCAL_C_INCLUDES:= \
	...
	$(LOCAL_PATH)/../SuiteSparse/COLAMD/Include $(LOCAL_PATH)/../SuiteSparse/UFconfig
